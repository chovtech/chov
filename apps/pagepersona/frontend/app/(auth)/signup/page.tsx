        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-[#00AE7E] focus:border-[#00AE7E] transition-all outline-none text-gray-900 ${fieldErrors.name ? 'border-red-400 bg-red-50' : 'border-gray-300'}`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-[#00AE7E] focus:border-[#00AE7E] transition-all outline-none text-gray-900 ${fieldErrors.email ? 'border-red-400 bg-red-50' : 'border-gray-300'}`}
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2.5 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-[#00AE7E] focus:border-[#00AE7E] transition-all outline-none text-gray-900 pr-16 ${fieldErrors.password ? 'border-red-400 bg-red-50' : 'border-gray-300'}`}
              />
              <button
                type="button"
