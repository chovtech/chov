    ...
    <>
      <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="mt-6">
          ...
          <button type="button" className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-gray-700 font-medium">
