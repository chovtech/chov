          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className={`w-full px-4 py-2.5 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-[#1A56DB] focus:border-[#1A56DB] transition-all outline-none text-gray-900 pr-12 ${
