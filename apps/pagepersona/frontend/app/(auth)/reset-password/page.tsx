  ...
  if (done) {
    return (
      <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center">
        ...
        <Link
          href="/login"
          className="w-full flex items-center justify-center gap-2 py-3.5 bg-[#00AE7E] hover:bg-[#009970] text-white font-bold rounded-xl transition-colors"
        >
    ...
    <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-12 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00AE7E]/20 focus:border-[#00AE7E] outline-none text-gray-900 transition-all"
            />
        ...
        <button
          ...
          className="w-full py-3.5 bg-[#00AE7E] hover:bg-[#009970] disabled:opacity-60 text-[#131432] font-bold rounded-xl transition-colors flex items-center justify-center gap-2 shadow-md shadow-[#00AE7E]/20"
        >
          {loading ? (
            <>
      ...
      <div className="mt-8 text-center">
        <Link href="/login" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-[#00AE7E] transition-colors">
