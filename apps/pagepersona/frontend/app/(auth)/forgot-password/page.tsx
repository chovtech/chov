          ...
          <div className="fixed top-6 right-6 z-50 animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="bg-white border border-green-100 shadow-xl rounded-xl p-4 flex items-center gap-4 min-w-[300px]">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-semibold text-sm">Reset link resent!</p>
                <p className="text-slate-500 text-xs mt-0.5">Check your inbox again shortly.</p>
              </div>
              <button
          ...
          <div className="space-y-3">
            ...
            <div className="pt-4 border-t border-slate-100">
              ...
              <button
                ...
                disabled={resending}
                className="flex items-center justify-center gap-1.5 mx-auto text-sm font-semibold text-[#1A56DB] hover:text-[#1547b3] transition-colors disabled:opacity-60"
              >
  ...
  return (
    <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A56DB]/20 focus:border-[#1A56DB] outline-none text-gray-900 transition-all"
            />
          </div>
        </div>
      ...
      <div className="mt-8 pt-6 border-t border-slate-100 text-center">
        <Link
          href="/login"
          className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-[#1A56DB] transition-colors"
        >
