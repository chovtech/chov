...
const ACTION_TYPES = [
  ...
  { key: 'show_element',     label: 'Show element',     icon: 'visibility',     needsElement: true  },
  { key: 'swap_url',         label: 'Swap URL',         icon: 'link',           needsElement: true  },
...
function EditRulePageInner() {
  ...
  const addAction = (actionType: any) => {
    setActions(prev => [...prev, {
      id: Date.now().toString(),
      type: actionType.key,
      type_label: actionType.label || actionType.key,
      target_block: '',
      value: '',
