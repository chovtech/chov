  ...
  return (
    <header className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-40 px-6 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        {/* Create with AI */}
        {!isViewOnly && <button className="flex items-center gap-2 px-4 py-2 bg-[#1A56DB] hover:bg-[#1547b3] text-white rounded-xl text-sm font-bold transition-all shadow-md shadow-[#1A56DB]/20 hover:scale-[1.02] active:scale-[0.98]">
